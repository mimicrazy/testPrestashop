        ...
        if ($associationName = explode(':', $patternName)) {
            ...
            elseif ($totalNameUsed == 1) {
                ...
                if (in_array($associationName[0], self::$forbiddenPropertyList) ||
                 ! $this->_checkValidateClassField('Address', 
                $associationName[0], false))
                    $this->_errorFormatList[] = Tools::displayError(
                        ...
                        if ($associateName = explode(':', $pattern)) {
                            ...
                            if ($totalName == 1 &&
                             isset($address->{$associateName[0]}))
                                ...
                                if (($totalName ==
                                 2) && class_exists($associateName[0]) &&
                                 Tools::property_exists($associateName[0], 
                                $associateName[1]) &&
                                 Tools::property_exists($address, 
                                'id_' . strtolower($associateName[0]))) {
                                    $idFieldName = 'id_' .
