...
class CompareProductCore extends ObjectModel
{
    ...
    public static function addGuestCompareProduct ($id_guest, $id_product)
    {
        ...
        '
			INSERT INTO `' .
         _DB_PREFIX_ . 'compare_product` (`id_product`, `id_guest`, `id_customer`, `date_add`, `date_upd`) 
			VALUES (' .
         (int) ($id_product) . ', ' . (int) ($id_guest) . ', 0, NOW(), NOW())
		');
    }
    /**
    ...
    public static function addCustomerCompareProduct ($id_customer, $id_product)
    {
        ...
        '
			INSERT INTO `' .
         _DB_PREFIX_ .
         'compare_product` (`id_product`, `id_guest`, `id_customer`, `date_add`, `date_upd`)
			VALUES (' .
         (int) ($id_product) . ', 0, ' . (int) ($id_customer) . ', NOW(), NOW())');
    }
    /**
    ...
    public static function cleanCompareProducts ($period = 'week')
    {
        ...
        if ($interval != null) {
			...
			WHERE date_upd < DATE_SUB(NOW(), INTERVAL ' .
             pSQL($interval) . ')');
        }
    }
}