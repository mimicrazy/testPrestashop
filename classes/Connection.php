...
class ConnectionCore extends ObjectModel
{
    ...
    public static function setPageConnection ($cookie, $full = true)
    {
        ...
        return array('id_connections' => (int) ($cookie->id_connections), 
    ...
    $time)
    {
		...
		SET `time_end` = `time_start` + INTERVAL ' .
         (int) ($time / 1000) . ' SECOND
    ...
    public static function cleanConnectionsPages ()
    {
        ...
        if ($interval != null) {
			...
			WHERE time_start < LAST_DAY(DATE_SUB(NOW(), INTERVAL ' .
             $interval . '))');
        }
    }
}
