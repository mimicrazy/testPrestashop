...
class PackCore extends Product
{
    ...
    public static function getItemTable ($id_product, $id_lang, $full = false)
    {
		...
		LEFT JOIN `' .
         _DB_PREFIX_ .
         'product` p ON p.id_product = a.id_product_item
		LEFT JOIN `' .
         _DB_PREFIX_ .
    ...
    public static function deleteItems ($id_product)
    {
        ...
        'UPDATE ' . _DB_PREFIX_ .
         'product SET cache_is_pack = 0 WHERE id_product = ' . (int) ($id_product) .
         ' LIMIT 1');
    ...
    public static function addItem ($id_product, $id_item, $qty)
    {
        Db::getInstance()->Execute(
        'UPDATE ' . _DB_PREFIX_ .
         'product SET cache_is_pack = 1 WHERE id_product = ' . (int) ($id_product) .
         ' LIMIT 1');
    ...
    public static function duplicate ($id_product_old, $id_product_new)
    {
        ...
        'INSERT INTO ' . _DB_PREFIX_ .
         'pack (id_product_pack, id_product_item, quantity)
		(SELECT ' .
         (int) ($id_product_new) . ', id_product_item, quantity FROM ' .
