...
class RangePriceCore extends ObjectModel
{
    ...
    protected $fieldsValidate = array('id_carrier' => 'isInt', 
    'delimiter1' => 'isUnsignedFloat', 'delimiter2' => 'isUnsignedFloat');
    protected $table = 'range_price';
    protected $identifier = 'id_range_price';
    protected $webserviceParameters = array('objectsNodeName' => 'price_ranges', 
