...
class OrderFollowControllerCore extends FrontController
{
    ...
    public function preProcess ()
    {
        ...
        if (Tools::isSubmit('submitReturnMerchandise')) {
            ...
            if ($customizationIds = Tools::getValue('customization_ids') and
             ! $customizationQtyInput)
                Tools::redirect('order-follow.php?errorDetail1');
            if (! $ids_order_detail = Tools::getValue('ids_order_detail') and
             ! $customizationIds)
            ...
            if (! $orderReturn->checkEnoughProduct($ids_order_detail, 
            $order_qte_input, $customizationIds, $customizationQtyInput))
            ...
            Module::hookExec('orderReturn', 
            array('orderReturn' => $orderReturn));
            Tools::redirect('order-follow.php');
        }
        $ordersReturn = OrderReturn::getOrdersReturn(
    ...
    public function setMedia ()
    {
        ...
        Tools::addJS(
        array(_PS_JS_DIR_ . 'jquery/jquery.scrollTo-1.4.2-min.js', 
