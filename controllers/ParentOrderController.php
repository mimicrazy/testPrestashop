...
class ParentOrderControllerCore extends FrontController
{
    ...
    protected function _processCarrier ()
    {
        ...
        if (Validate::isInt(Tools::getValue('id_carrier')) and
         sizeof(
    ...
    {
        global $currency;
        if (file_exists(_PS_SHIP_IMG_DIR_ . (int) (self::$cart->id_carrier) .
         '.jpg'))
    ...
    protected function _assignAddress ()
    {
        ...
        if (Configuration::get('PS_GUEST_CHECKOUT_ENABLED') == 0 and
         ((int) self::$cookie->is_guest !=
    ...
    protected function _assignWrappingAndTOS ()
    {
        ...
        // TOS
        $cms = new CMS((int) (Configuration::get('PS_CONDITIONS_CMS_ID')), 
        (int) (self::$cookie->id_lang));
